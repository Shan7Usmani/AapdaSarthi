    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex flex-1 flex-col items-center gap-6 px-4 py-10">
        <div className="max-w-md text-center">
          <div className="mb-2 flex items-center justify-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] neon-red">
            <Siren className="h-4 w-4" /> Citizen distress channel
          </div>
          <h1 className="font-display text-3xl font-black tracking-tight text-foreground">Report an SOS</h1>
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-7 gap-y-2 text-[12px] font-medium text-muted">
          <span className="flex items-center gap-1.5">
            <Radio className="h-4 w-4 text-[#00b4d8]" /> routed to nearest rescuer
          </span>
          <span className="flex items-center gap-1.5">
            <Users className="h-4 w-4 text-[#00b4d8]" /> multilingual confirmation
          </span>
        </div>
      </main>
